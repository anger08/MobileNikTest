...
class NetworkService {
    ...
    private let baseUrl = "https://hf-android-app.s3-eu-west-1.amazonaws.com/android-test/"
    ...
    func request<T: MBEndpoint>(endpoint: T, completion: @escaping (Swift.Result<Data?, Error>) -> Void) {
